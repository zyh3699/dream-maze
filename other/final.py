  ...
  (3 if (r == 239 and g == 55 and b == 58) else 
   (4 if (r ==42 and g ==62 and b ==214) else 
    (5 if (r == 0 and g == 122 and b == 65) else 
      (6 if (r == 126 and g == 61 and b == 214) else 0))))))
...
if __name__ == "__main__":
    image_path = './img/bgr/final_background_marked.png'  
    json_path = './other/collision_final.json'  # 保存的JSON文件路径
    ...
    marked_image.save('marked_final.png')  # 保存标记后的图片