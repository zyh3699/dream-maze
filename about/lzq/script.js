    ...
    switch(section) {
        case 'home':
            textBox.innerHTML = `
                ...
                <img src="img/lzq.jpg" alt="Home Image" style="position: absolute; top: 30px; right: 30px; width: 300px; height: auto;">
        ...
        case 'contact':
            textBox.innerHTML = `
                ...
                <p style="text-align: left;font-size: 30px;font-family:楷体;">你可以通过以下方式联系我：</p>
