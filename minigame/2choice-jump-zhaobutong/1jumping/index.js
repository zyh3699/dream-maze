...
function gameOver() {
    ...
    if (lifeCount <= 0) {
        alert('生命值已耗尽...恭喜您成功识破了梦境的迷幻。现实里只需要达到target...但是在梦境里，您需要die五次...否则会无休止的进入循环...您成功逃离了梦境！！！');
...
// Hook this function to your existing game over logic
...
function init() {
    ...
    stars.height = 0.5*window.innerHeight;
