...
def generate_collision_map(image_path):
    ...
    for y in range(height):
        ...
        for x in range(width):
            ...
            # 如果是白色像素，则标记为1，否则为0
            row.append(1 if r == 255 and g == 255 and b == 255 else 0)
...
if __name__ == "__main__":
    image_path = '../img/bgr/chapter1_background.png'  
    json_path = 'collision_map.json'  # 保存的JSON文件路径
    ...
    marked_image.save('../img/bgr/marked_image.png')  # 保存标记后的图片