...
fetch("../other/collision_final.json")
...
function update(deltatime) {
  ...
  if ((keysPressed["ArrowUp"] || keysPressed["w"] || keysPressed["W"]) && window.player.isconversation == 0){
  ...
  if ((keysPressed["e"] || keysPressed["E"]) && window.player.isconversation == 0){
